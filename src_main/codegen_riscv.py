...
def test_riscv(intermediate, textNamePrefix, textNameSuffix, headerName, dataBase, bssBase, bssSizePerThread, signatureSize, regBitWidth, numExecutions, fixedLoadReg, platform, profileName, numCores, strideType, verbosity):
    ...
    for thread in intermediate:
        ...
        riscvList.append("    #      When incrementing      | When busy-waiting")
        ...
        riscvList.append("    bnez %s,2f" % (regSync2))
        ...
        riscvList.append("")
        riscvList.append("    # Incrementing counter")
        ...
        riscvList.append("    beqz %s,5f  # %s contains new pointer" % (regSync2,regSync2))
        riscvList.append("    la %s,thread_exec_barrier0" % (regSync1))
        riscvList.append("    j 4f")
        riscvList.append("5:  la %s,thread_exec_barrier1" % (regSync1))
...
def manager_riscv(managerFileName, headerName, threadList, signatureSize, regBitWidth, numCores, strideType):
    ...
    managerString += "#define TESTNUM x28\n"
    managerString += "\n"
    ...
    managerString += "    li x1, 0\n"
    managerString += "    li x2, 0\n"
    managerString += "    li x3, 0\n"
    managerString += "    li x4, 0\n"
    managerString += "    li x5, 0\n"
    managerString += "    li x6, 0\n"
    managerString += "    li x7, 0\n"
    managerString += "    li x8, 0\n"
    managerString += "    li x9, 0\n"
    managerString += "// save a0 and a1; arguments from previous boot loader stage:\n"
    managerString += "//    li x10, 0\n"
    managerString += "//    li x11, 0\n"
    managerString += "    li x12, 0\n"
    managerString += "    li x13, 0\n"
    managerString += "    li x14, 0\n"
    managerString += "    li x15, 0\n"
    managerString += "    li x16, 0\n"
    managerString += "    li x17, 0\n"
    managerString += "    li x18, 0\n"
    managerString += "    li x19, 0\n"
    managerString += "    li x20, 0\n"
    managerString += "    li x21, 0\n"
    managerString += "    li x22, 0\n"
    managerString += "    li x23, 0\n"
    managerString += "    li x24, 0\n"
    managerString += "    li x25, 0\n"
    managerString += "    li x26, 0\n"
    managerString += "    li x27, 0\n"
    managerString += "    li x28, 0\n"
    managerString += "    li x29, 0\n"
    managerString += "    li x30, 0\n"
    managerString += "    li x31, 0\n"
    managerString += "    la t0, trap_vector\n"
    managerString += "    csrw mtvec, t0\n"
    managerString += "    csrwi mstatus, 0\n"
